...
import com.lenin.securedoc.domain.Token;
import com.lenin.securedoc.domain.TokenData;
import com.lenin.securedoc.dto.User;
import com.lenin.securedoc.enumeration.TokenType;
import com.lenin.securedoc.function.TriConsumer;
...
import static com.lenin.securedoc.enumeration.TokenType.ACCESS;
import static com.lenin.securedoc.enumeration.TokenType.REFRESH;
...
public class JwtServiceImpl extends JwtConfiguration implements JwtService {
    ...
    private BiFunction<HttpServletRequest, String, Optional<Cookie>> extractCookie = (request, cookieName) ->
            Optional.of(stream(request.getCookies() == null ? new Cookie[]{new Cookie(EMPTY_VALUE, EMPTY_VALUE)} : request.getCookies())
                    .filter(cookie -> Objects.equals(cookieName, cookie.getName()))
